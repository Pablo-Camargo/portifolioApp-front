      ...
      <Row className="profileParent">
        <Col xs={{order: 'last' }} className="profileDetails">
          ...
          <div className="profileDetails">
            <span className="primaryText helloProfile">Hello, My name is</span>
          ...
          <div className="profileRole">
            <div className="warper">
              <div className="contentRole">
                  <div className='primaryInner'>   Ethusiastic Dev</div>
                  <div className='primaryInner'>   Full Stack Developer</div>
                  <div className='primaryInner'>   React/React Native ethusiastic</div>
              </div>
            </div>
          ...
          <div className="colz">
             <a href="https://github.com/Pablo-Camargo" target={'_blank'} rel="noreferrer" >
              <FaGithub/>
            </a>
             <a href="https://www.linkedin.com/in/pablo-henrique-m-c-elias-9b00b4207/" target={'_blank'} rel="noreferrer" >
              <FaLinkedin/>
            </a>
             <a href="https://www.instagram.com/pablo_camargo_/" target={'_blank'} rel="noreferrer" >
              <FaInstagram/>
            </a>
